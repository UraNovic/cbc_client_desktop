  ...
  return {
    ...
    link: function (scope, elm, attr, ctrl) {
      ...
      var validator = function(value) {
        ...
        if (attr.rpDestAddress && cbcAddressCodec.isValidAddress(strippedValue)) {
...
module.directive('rpAmountcbcLimit', function () {
  return {
    ...
    link: function (scope, elm, attr, ctrl) {
      ...
      // We don't use parseAmount here, assuming that you also use rpAmount validator
      var validator = function(value) {
        var currency = Currency.from_json(attr.rpAmountcbcLimitCurrency);

        // If cbc, ensure amount is less than 100 billion and is at least one drop
      ...
      attr.$observe('rpAmountcbcLimitCurrency', function() {
        validator(ctrl.$viewValue);
      });
    }
  };

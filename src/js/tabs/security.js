...
var cbcAddress = require('../util/types').cbcAddress;
var fs = require('fs');
...
SecurityTab.prototype.angular = function (module) {
    ...
    function ($scope, $id, keychain, $timeout, authflow, popup, network, fileDialog)
  {
    ...
    $scope.generateRegularKey = function() {
      ...
      $scope.regularKeyPublic = new cbcAddress($scope.regularKey).getAddress();
    ...
    // Unset regular key with cbc transaction, so key is no longer valid

...
SettingsTradeTab.prototype.generateHtml = function() {
  return require('../../templates/tabs/settingstrade.jade')();
};
  ...
  function SettingsTradeCtrl($scope, $timeout) {
    ...
    $scope.dragControlListeners = {
        orderChanged: function(event) {
          ...
          $scope.userBlob.set('/clients/cbctradecom/trade_currency_pairs/' + event.source.index, sourceObj);
          $scope.userBlob.set('/clients/cbctradecom/trade_currency_pairs/' + event.dest.index, destObj);
        }
    };
  }
};

...
describe('AppCtrl', function(){
  ...
  describe('Public Functions', function () {
    ...
    it('should handle cbc lines', function(done) {
      assert.isFunction(ctrl.handlecbcLines);
      run(scope,done);
    });

    it('should handle cbc lines error', function(done) {
      assert.isFunction(ctrl.handlecbcLinesError);
      run(scope,done);
    });
    ...
    it('should update the cbc lines', function(done) {
      assert.isFunction(ctrl.updateLines);
      run(scope,done);
    });

    it('should should update the cbc balance', function(done) {
      assert.isFunction(ctrl.updatecbcBalance);
      run(scope,done);
    });
